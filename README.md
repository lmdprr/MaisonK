...
1. Créer le Worker et le connecter au dépôt GitHub (Workers Builds).
   - Build : `npx opennextjs-cloudflare build && node scripts/sync-r2.mjs`
   - Déploiement : `npx opennextjs-cloudflare deploy`
